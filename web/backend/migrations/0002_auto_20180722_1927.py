# Generated by Django 2.0.7 on 2018-07-22 23:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='web.Summary')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='soccertournament_set', to='web.Topic')),
            ],
            options={
